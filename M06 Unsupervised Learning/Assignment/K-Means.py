# Using the shoppers.csv file, run k-Means cluster analysis by shopper annual_income_k and spending_score. 
# Include the centroid. 
...
# Apply k-means clustering with the chosen number of clusters (n == 5)
